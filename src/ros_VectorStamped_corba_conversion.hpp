#ifndef __ROS_kdl_msgs_VectorStamped_CORBA_CONVERSION__
#define __ROS_kdl_msgs_VectorStamped_CORBA_CONVERSION__
...
namespace RTT
{
  namespace corba{
    ...
    template<>
    struct AnyConversion< kdl_msgs::VectorStamped >
    {
      typedef CORBA::OctetSeq CorbaType;
      typedef kdl_msgs::VectorStamped StdType;
