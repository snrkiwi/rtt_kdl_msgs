#ifndef __ROS_kdl_msgs_Frame_CORBA_CONVERSION__
#define __ROS_kdl_msgs_Frame_CORBA_CONVERSION__
...
namespace RTT
{
  namespace corba{
    ...
    template<>
    struct AnyConversion< kdl_msgs::Frame >
    {
      typedef CORBA::OctetSeq CorbaType;
      typedef kdl_msgs::Frame StdType;
