#ifndef __ROS_kdl_msgs_WrenchStamped_CORBA_CONVERSION__
#define __ROS_kdl_msgs_WrenchStamped_CORBA_CONVERSION__
...
namespace RTT
{
  namespace corba{
    ...
    template<>
    struct AnyConversion< kdl_msgs::WrenchStamped >
    {
      typedef CORBA::OctetSeq CorbaType;
      typedef kdl_msgs::WrenchStamped StdType;
