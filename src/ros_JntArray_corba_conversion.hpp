#ifndef __ROS_kdl_msgs_JntArray_CORBA_CONVERSION__
#define __ROS_kdl_msgs_JntArray_CORBA_CONVERSION__
...
namespace RTT
{
  namespace corba{
    ...
    template<>
    struct AnyConversion< kdl_msgs::JntArray >
    {
      typedef CORBA::OctetSeq CorbaType;
      typedef kdl_msgs::JntArray StdType;
