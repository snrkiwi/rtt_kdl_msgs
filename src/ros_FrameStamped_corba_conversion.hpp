#ifndef __ROS_kdl_msgs_FrameStamped_CORBA_CONVERSION__
#define __ROS_kdl_msgs_FrameStamped_CORBA_CONVERSION__
...
namespace RTT
{
  namespace corba{
    ...
    template<>
    struct AnyConversion< kdl_msgs::FrameStamped >
    {
      typedef CORBA::OctetSeq CorbaType;
      typedef kdl_msgs::FrameStamped StdType;
