#ifndef __ROS_kdl_msgs_TwistStamped_CORBA_CONVERSION__
#define __ROS_kdl_msgs_TwistStamped_CORBA_CONVERSION__
...
namespace RTT
{
  namespace corba{
    ...
    template<>
    struct AnyConversion< kdl_msgs::TwistStamped >
    {
      typedef CORBA::OctetSeq CorbaType;
      typedef kdl_msgs::TwistStamped StdType;
