#ifndef __ROS_kdl_msgs_Twist_CORBA_CONVERSION__
#define __ROS_kdl_msgs_Twist_CORBA_CONVERSION__
...
namespace RTT
{
  namespace corba{
    ...
    template<>
    struct AnyConversion< kdl_msgs::Twist >
    {
      typedef CORBA::OctetSeq CorbaType;
      typedef kdl_msgs::Twist StdType;
