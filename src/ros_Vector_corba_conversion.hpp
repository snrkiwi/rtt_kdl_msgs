#ifndef __ROS_kdl_msgs_Vector_CORBA_CONVERSION__
#define __ROS_kdl_msgs_Vector_CORBA_CONVERSION__
...
namespace RTT
{
  namespace corba{
    ...
    template<>
    struct AnyConversion< kdl_msgs::Vector >
    {
      typedef CORBA::OctetSeq CorbaType;
      typedef kdl_msgs::Vector StdType;
