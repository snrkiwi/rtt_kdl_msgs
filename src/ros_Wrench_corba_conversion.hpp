#ifndef __ROS_kdl_msgs_Wrench_CORBA_CONVERSION__
#define __ROS_kdl_msgs_Wrench_CORBA_CONVERSION__
...
namespace RTT
{
  namespace corba{
    ...
    template<>
    struct AnyConversion< kdl_msgs::Wrench >
    {
      typedef CORBA::OctetSeq CorbaType;
      typedef kdl_msgs::Wrench StdType;
