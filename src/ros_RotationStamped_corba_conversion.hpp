#ifndef __ROS_kdl_msgs_RotationStamped_CORBA_CONVERSION__
#define __ROS_kdl_msgs_RotationStamped_CORBA_CONVERSION__
...
namespace RTT
{
  namespace corba{
    ...
    template<>
    struct AnyConversion< kdl_msgs::RotationStamped >
    {
      typedef CORBA::OctetSeq CorbaType;
      typedef kdl_msgs::RotationStamped StdType;
