#ifndef __ROS_kdl_msgs_JntArrayStamped_CORBA_CONVERSION__
#define __ROS_kdl_msgs_JntArrayStamped_CORBA_CONVERSION__
...
namespace RTT
{
  namespace corba{
    ...
    template<>
    struct AnyConversion< kdl_msgs::JntArrayStamped >
    {
      typedef CORBA::OctetSeq CorbaType;
      typedef kdl_msgs::JntArrayStamped StdType;
